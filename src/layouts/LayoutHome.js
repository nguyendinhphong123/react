                ...
                <div className="col-lg-6 col-md-12 col-12">
                  <div className="product-gallery product-gallery-vertical d-flex">
                    ...
                    <div className="product-img-thumb">
                      <div
                        className="qv-thumb-slider img-thumb-slider common-slider"
                ...
                <div className="col-lg-6 col-md-12 col-12">
                  <div className="product-details ps-lg-4">
                    ...
                    <div className="guaranteed-checkout">
                      <strong className="label mb-1 d-block">
                        Guaranteed safe checkout:
                      </strong>
                      <ul className="list-unstyled checkout-icon-list d-flex align-items-center flex-wrap">
                        <li className="checkout-icon-item">
                          <svg
                            width={38}
                            height={24}
                            viewBox="0 0 38 24"
